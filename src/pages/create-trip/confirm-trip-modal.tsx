          ...
          <div className="w-[640px] rounded-xl py-5 px-6 bg-zinc-900 space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-sm text-zinc-400">
                Para concluir a criação da viagem para <span className="font-semibold text-zinc-100">Florianópolis, SC </span>
                nas datas de <span className="font-semibold text-zinc-100">20 a 25 de Junho de 2025</span>, preencha seus dados abaixo:
              </p>
            </div>
